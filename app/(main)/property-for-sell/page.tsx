      ...
      <div className="pt-32 pb-16 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            List your property with PropertyHub and reach thousands of verified buyers. Get the best price for your property.
          </p>
        </div>
      </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-white/95 backdrop-blur-sm border-2 border-gray-200 focus:border-blue-500 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all duration-300 rounded-xl"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        />
                        <label htmlFor="furnished" className="text-sm text-gray-700 flex items-center">
                      ...
                      <div className="flex items-center space-x-3">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => handleCheckboxChange('readyToMove', checked as boolean)}
                        />
                        <label htmlFor="readyToMove" className="text-sm text-gray-700 flex items-center">
          ...
          <div className="space-y-6">
            <Card className="bg-gradient-to-r from-blue-600 to-purple-600 text-white border-0 shadow-xl rounded-3xl overflow-hidden">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4">Why List with PropertyHub?</h3>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-2 border-white/50 shadow-xl rounded-3xl overflow-hidden">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Our property experts are here to help you list your property successfully.</p>
                <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white border-0 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl">
                  Contact Expert
                </Button>
              </CardContent>
            </Card>

            <Card className="bg-gradient-to-r from-pink-600/10 to-red-600/10 backdrop-blur-sm border-2 border-pink-200/50 rounded-3xl overflow-hidden">
              <CardContent className="p-6">
                <h3 className="text-xl font-bold mb-4 text-pink-800">Quick Tips</h3>
